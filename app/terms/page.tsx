    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-950 text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <p className="text-xl text-gray-400 mb-12">
          Our full terms of service are being finalized.
        </p>

        <div className="bg-white/5 rounded-lg p-8 backdrop-blur-sm space-y-6">
          <div>
            <h2 className="text-2xl font-bold mb-3">Fair Use</h2>
            <p className="text-gray-400">
              We expect all users to use our platform responsibly and in good faith.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-400">
              ...
              <a href="mailto:legal@chatforge.ai" className="text-white hover:underline">
                legal@chatforge.ai
              </a>
            </p>
          </div>
